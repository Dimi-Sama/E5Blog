...
<body>
  ...
  <div class="container">
    <form class="fomulaire" action="scriptUpdate.php" method="post" enctype="multipart/form-data">
      <input style="display: none;" value="<?php echo $art['id'] ?>" name="idArt" type="text">
      <div>
      ...
      <div>
        ...
        <textarea name="article" cols="30" rows="10"> <?php echo $art['contenu'] ?></textarea>
      </div>
